...
วิธีใช้งาน
เข้าไปที่ลิงก์เว็บไซต์: (https://poodlt986-dev.github.io/money.app/)
เริ่มกดเพิ่มรายรับหรือรายจ่ายได้เลย
แตะที่การ์ด "เหลือใช้ได้วันนี้" เพื่อตั้งงบประมาณ (ต้องมีรายรับก่อนนะ ไม่งั้นจะตั้งไม่ได้)
ข้อมูลจะถูกเซฟอัตโนมัติ ปิดเว็บแล้วเปิดใหม่ข้อมูลก็ยังอยู่ครบ
...
How to use
Go to the website link: (https://poodlt986-dev.github.io/money.app/)
Start adding your income or expenses.
Tap the "Remaining today" card to set a daily budget (Note: You must log some income first before setting a budget).
Data saves automatically. Close the tab, reopen it later, and your records will still be there.
